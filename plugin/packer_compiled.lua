...
_G.packer_plugins = {
  ...
  ["onedark.nvim"] = {
    loaded = true,
    path = "/Users/omerdangoor/.local/share/nvim/site/pack/packer/start/onedark.nvim",
  ...
  ["vim-floaterm"] = {
    loaded = true,
    path = "/Users/omerdangoor/.local/share/nvim/site/pack/packer/start/vim-floaterm",
